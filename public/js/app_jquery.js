  ...
  $.ajax({
    ...
    for (var item in data) {
      ...
      if (data[item]['user_like'] == 0) {
        ...
        // いいねが押されていない場合
        show = "" + data[item]['no'] + ": " + user + " " + data[item]['time'] + "<br>" + "<p style='overflow-wrap: break-word;'>" + msg + "</p>" + "<br>" + "<button type='button' class='btn btn-dark' onClick='likes(" + data[item]['no'] + ", " + 1 + ")'>like</button> " + data[item]['count_user'] + "<hr>";
      }
