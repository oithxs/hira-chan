        ...
        <div class="row">
            ...
            <div class="py-12 col-lg-3 col-md-12">
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-2">
                    ...
                    <a class="twitter-timeline" data-chrome="nofooter" data-width="400" data-height="550" data-user_page_theme_id="light" href="https://twitter.com/hxs_?ref_src=twsrc%5Etfw">Tweets by
                        hxs_</a>
                    @elseif (Auth::user()->user_page_theme_id == 2)
                    <a class="twitter-timeline" data-chrome="nofooter" data-width="400" data-height="550" data-user_page_theme_id="dark" href="https://twitter.com/hxs_?ref_src=twsrc%5Etfw">Tweets by hxs_</a>
                    @endif
