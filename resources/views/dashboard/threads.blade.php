             ...
             <th>
                <div class="hidden sm:flex sm:items-center">
                    ...
                    <div class=" text-lg text-right leading-7 font-semibold ms-auto ">
                        ...
                        <button type="button" class="btn btn-default justify-continent-md-end " data-bs-toggle="modal" data-bs-target="#exampleModal">
 ...
 <div class="modal-dialog modal-dialog-centered">
     <div class="modal-content">
         ...
         <div class="modal-footer">
             ...
             <button id="dashboard_create_thread_btn" type="button" class="btn btn-primary bg-primary" data-bs-dismiss="modal">
                 Save changes
             </button>
         </div>
     </div>
